...
!(function webpackMissingModule() { var e = new Error("Cannot find module '../../../EventService'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return !(function webpackMissingModule() { var e = new Error("Cannot find module '../../../EventService'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).addEvent(_this.Event);
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return !(function webpackMissingModule() { var e = new Error("Cannot find module '../../../EventService'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).deleteEvent(this.Event.id);
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 4;
                return !(function webpackMissingModule() { var e = new Error("Cannot find module '../../../EventService'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).editEvent(this.updatedEvent);
...
/* harmony import */ var _AddEvent__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./AddEvent */ "./resources/js/components/AdminComponents/EventComponents/AddEvent.vue");
/* harmony import */ var _EditEvent__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./EditEvent */ "./resources/js/components/AdminComponents/EventComponents/EditEvent.vue");
/* harmony import */ var _ShowEvent__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./ShowEvent */ "./resources/js/components/AdminComponents/EventComponents/ShowEvent.vue");
/* harmony import */ var _DeleteEvent__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./DeleteEvent */ "./resources/js/components/AdminComponents/EventComponents/DeleteEvent.vue");
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    addEvent: _AddEvent__WEBPACK_IMPORTED_MODULE_2__["default"],
    editEvent: _EditEvent__WEBPACK_IMPORTED_MODULE_3__["default"],
    showEvent: _ShowEvent__WEBPACK_IMPORTED_MODULE_4__["default"],
    deleteEvent: _DeleteEvent__WEBPACK_IMPORTED_MODULE_5__["default"]
  },
  data: function data() {
    return {
      q: '',
  ...
  methods: {
    getResults: function getResults() {
      this.$store.dispatch('getListOfEvents');
    },
    findEvent: function findEvent() {
      this.q.length > 0 ? this.$store.dispatch('getEvent', this.q) : this.getResults();
    },
  ...
  computed: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_1__["mapState"])(["events"])), Object(vuex__WEBPACK_IMPORTED_MODULE_1__["mapGetters"])(["getEvents"])),
  filters: {
    ...
    [
      ...
      _c(
        ...
        [
          ...
          _vm._v(" "),
          _vm.getEvents.data.length > 0
            ? _c(
                "div",
                _vm._l(_vm.getEvents.data, function(event) {
                  return _c(
                    "v-card",
