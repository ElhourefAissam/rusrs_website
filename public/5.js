          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 6;
                return _this.$store.dispatch("addProgram", _this.Program);
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return this.$store.dispatch("deleteProgram", this.Program.id);
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 4;
                return this.$store.dispatch("editProgram", this.updatedProgram);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getResults: function getResults() {
      this.$store.dispatch("getListOfPrograms", this.q);
    },
  ...
  computed: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_1__["mapState"])(["programs"])), Object(vuex__WEBPACK_IMPORTED_MODULE_1__["mapGetters"])(["getPrograms"])),
  filters: {
    ...
    [
      ...
      _c(
        ...
        [
          ...
          _vm._v(" "),
          _vm.getPrograms.data.length > 0
            ? _c(
                "div",
                _vm._l(_vm.getPrograms.data, function(program) {
                  return _c(
                    "v-card",
                    {
                      key: program.id,
          ...
          _c(
            ...
            [
              _c("pagination", {
                staticClass: "mt-5",
                attrs: { data: _vm.getPrograms },
                on: { "pagination-change-page": _vm.getPrograms }
              })
            ],
            1
          )
